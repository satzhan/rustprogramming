...
fn main() { // added RNG for task distribution
    ...
    for worker_id in 0..4 {
        ...
        // Each worker gets its own RNG, seeded from the worker_id
        // so runs are reproducible but workers are independent
        ...
        let handle = thread::spawn(move || {
            for i in 0..6 {
                ...
                // Jitter the duration a bit: 20-40ms
